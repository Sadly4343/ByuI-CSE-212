...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Fixed the queue to properly add the person to the end from the beginning. Issue of Assert.AreEqual
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Created an Elif statement to deal with forever numbers. Issue of Assert.AreEqual
    ...
    // Defect(s) Found: Created an Else If statement to deal with negative numbers. Issue of Assert.AreEqual
